...
var createTables = function () { return __awaiter(void 0, void 0, void 0, function () {
    var connection, createProductsTable, createUsersTable, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, connection.execute(createProductsTable)];
            case 3:
                _a.sent();
                console.log('Products table created successfully!');
                return [4 /*yield*/, connection.execute(createUsersTable)];
            case 4:
                _a.sent();
